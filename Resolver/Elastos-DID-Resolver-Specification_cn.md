...
字符串值，其中包含要调用的方法的名称。对DID Resolve请求，值为"did_resolveDID"。

#### params

对象值，包含在did_resolveDID方法调用中需要使用的参数。参数定义如下：
...
字符串值，其中包含要调用的方法的名称。对Credential Resolve请求，值为"did_resolveCredential"。

#### params

对象值，包含在did_resolveCredential方法调用中需要使用的参数。参数定义如下：
...
字符串值，其中包含要调用的方法的名称。对Credential List请求，值为"did_listCredentials"。

#### params

对象值，包含在did_listCredentials方法调用中需要使用的参数。参数定义如下：
